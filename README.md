...
- Pkg folder: [packages\entity-external-ids](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\entity-external-ids)
...
graph LR
  ...
  entity_external_ids["entity_external_ids"]:::center
```
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package entity-external-ids -Apply
