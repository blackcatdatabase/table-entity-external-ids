...
| Pkg folder | [packages\entity-external-ids](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\entity-external-ids) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package entity-external-ids -Apply
