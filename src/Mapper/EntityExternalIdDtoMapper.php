...
namespace BlackCat\Database\Packages\EntityExternalIds\Mapper;

use BlackCat\Database\Packages\EntityExternalIds\Dto\EntityExternalIdDto;
use BlackCat\Database\Packages\EntityExternalIds\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO EntityExternalIdDto:
...
final class EntityExternalIdDtoMapper
{
     ...
     * @return EntityExternalIdDto
     */
    public static function fromRow(array $row): EntityExternalIdDto
    {
        /** @var EntityExternalIdDto */
        return DtoHydrator::fromRow(
            EntityExternalIdDto::class,
            $row,
            self::COL_TO_PROP,
            self::BOOL_COLS,
            self::INT_COLS,
    ...
    public static function fromRowOrNull(?array $row): ?EntityExternalIdDto
    {
     ...
     *
     * @param EntityExternalIdDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(EntityExternalIdDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(EntityExternalIdDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(EntityExternalIdDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,EntityExternalIdDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,EntityExternalIdDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(EntityExternalIdDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,EntityExternalIdDto>
     */
