...
use BlackCat\Database\Packages\EntityExternalIds\Repository\EntityExternalIdRepository;
...
{
    private EntityExternalIdRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new EntityExternalIdRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\EntityExternalIds\Dto\EntityExternalIdDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\EntityExternalIds\Dto\EntityExternalIdDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\EntityExternalIds\Dto\EntityExternalIdDto|null
    {
