...
namespace BlackCat\Database\Packages\EntityExternalIds;
...
use BlackCat\Database\Packages\EntityExternalIds\Repository\EntityExternalIdRepository as GeneratedRepository;
...
{
  private EntityExternalIdRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof EntityExternalIdRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected EntityExternalIdRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\EntityExternalIds\Dto\EntityExternalIdDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\EntityExternalIds\Dto\EntityExternalIdDto|null { return $this->repo->getById($id, $asDto); }
