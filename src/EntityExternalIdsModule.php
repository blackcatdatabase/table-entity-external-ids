...
final class EntityExternalIdsModule implements ModuleInterface
{
    public function name(): string { return 'table-entity_external_ids'; }
    public function table(): string { return 'entity_external_ids'; }
    ...
    public static function contractView(): string { return 'vw_entity_external_ids'; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_ext_ids_external_id', 'idx_ext_ids_source' ];
        if ($d->isMysql()) {
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_ext_ids_external_id', 'idx_ext_ids_source' ],
            'foreignKeys' => [],
        ];
    }
}
