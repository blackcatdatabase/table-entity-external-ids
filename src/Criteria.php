...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'entity_table', 'entity_pk', 'source', 'external_id', 'created_at' ];
    }

    /** Columns used for full-text LIKE/ILIKE searches. */
    protected function searchable(): array
    {
        return [ 'entity_table', 'entity_pk', 'source', 'external_id' ];
    }

    /** Columns allowed in ORDER BY (falls back to filterable() when empty). */
    protected function sortable(): array
    {
        $x = [ 'id', 'entity_table', 'entity_pk', 'source', 'external_id', 'created_at' ];
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\EntityExternalIds\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\EntityExternalIds\Definitions::softDeleteColumn();
