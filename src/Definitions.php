...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'entity_external_ids'; }
    public static function contractView(): string { return 'vw_entity_external_ids'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'entity_table', 'entity_pk', 'source', 'external_id', 'created_at' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'entity_table', 'entity_pk', 'source' ], [ 'id' ] ]; }
